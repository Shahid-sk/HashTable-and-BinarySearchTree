...
public class HashMain {
	public static void main(String args[]) {
		...
		/**
		 * UC1 Counts the number of occurrence of given word in a string
		 */
		...
		/**
		 * UC2 Counts the number of occurrence of given word in a paragraph
		 */
		...
		/**
		 * UC3 Delete a word from given paragraph
		 */
